  ...
  return (
    <>
      <div className={twMerge('mb-6 flex flex-col items-start', className)}>
        ...
        <Label question={question} label={label} description={description} initialOpen={question.match('services sociétaux . su') || question.match('services sociétaux . explication su') || question.match('transport . voiture . km')} />
